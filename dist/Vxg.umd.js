...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BasicSide_vue_vue_type_style_index_0_id_edaf21a8_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("2627");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BasicSide_vue_vue_type_style_index_0_id_edaf21a8_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BasicSide_vue_vue_type_style_index_0_id_edaf21a8_prod_lang_scss__WEBPACK_IMPORTED_MODULE_0__);
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            if (_this.items.length != 0) {
              // this.tag_items = this.items.map(v => v.tag+(''==v.custom12?'':' ('+v.custom12+')'))
              _this.tag_items = _this.items.map(tagAlias);
              _this.tag_items2 = _this.items2.map(tagAlias);
              _this.setupMiniSearch(_this.items);
  ...
  watch: BasicSidevue_type_script_lang_js_defineProperty({
    ...
    '$store.state.trigger.search.b': function $storeStateTriggerSearchB(term) {
      ...
      if (term == '' && this.$refs.search2) {
        ...
        // this.tag_items = this.items.map(v => v.tag)
        this.tag_items2 = this.items2.map(function (v) {
          return v.tag;
        });
        //  this.$store.commit('set_path_data', null)
      }
      ...
      setTimeout(/*#__PURE__*/BasicSidevue_type_script_lang_js_asyncToGenerator(/*#__PURE__*/BasicSidevue_type_script_lang_js_regeneratorRuntime().mark(function _callee3() {
        ...
        return BasicSidevue_type_script_lang_js_regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 9:
              // this.tag_items = this.items.map(v => v.tag)
              if (_this2.items != undefined) _this2.tag_items = _this2.items.map(tagAlias);
            case 10:
            case "end":
              return _context3.stop();
          }
        ...
        return BasicSidevue_type_script_lang_js_regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              break;
            case 10:
              if (_this3.items2 != undefined) _this3.tag_items2 = _this3.items2.map(tagAlias);
            case 11:
            case "end":
              return _context4.stop();
          }
...
// EXTERNAL MODULE: ./src/components/BasicSide.vue?vue&type=style&index=0&id=edaf21a8&prod&lang=scss
var BasicSidevue_type_style_index_0_id_edaf21a8_prod_lang_scss = __webpack_require__("527f");
...
var BasicSide_component = normalizeComponent(
  ...
  BasicSidevue_type_template_id_edaf21a8_render,
  BasicSidevue_type_template_id_edaf21a8_staticRenderFns,
  false,
  null,
  null,
  null
